<%-- 
    Document   : AdministradorRegistroCaja
    Created on : 4/11/2018, 08:53:23 PM
    Author     : PC02
--%>
                ...
                <div class="container-fluid">
                    <div class="container">
                        ...
                        <form id="form1">
                            <div class="form-row">
                                <div class="col-md-6">
                                    <label> Identificación caja: </label>
                                    
                                    <input class="form-control" name="idCaja" id="idCaja">
                                    <br>
                                    <label> Monto inicial: </label>
                                    <input class="form-control" name="monto" id="monto">
                                </div>
                                <div class="col-md-1">
                                    <span></span>
                                </div>
...
<script>
                ...
                <script>
                    $(document).ready(function () {
                        $('#actualizar').click(function (event) {
                            ...
                            var act = "actualizar";
                            $.post('ServletAdministradorRegistroCaja', {
                                codigo: cod,
                                monto: prod,
                                idSM: sm,
                                actualizar: act
                                ...
                                if (typeof fc.error === "undefined") {
                                    mostrarTabla(fc);
                                    document.getElementById("idCaja").value = null;
                    ...
                    $(document).ready(function () {
                        $('#buscar').click(function (event) {
                            ...
                            $.post('ServletAdministradorRegistroCaja', {
                                ...
                                if (typeof fc.error === "undefined") {
                                    mostrarTabla(fc);
                                    document.getElementById("idCaja").value = fc.idCaja2;
                                    document.getElementById("monto").value = fc.monto2;
                ...
                <%
                    if(request.getAttribute("cajas")!=null){
                        String hola="'"+(String)request.getAttribute("cajas")+"'";
                %>
                <script>
